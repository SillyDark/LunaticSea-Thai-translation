return {
  ...
  profile_error_desc = '`⚠️` | **%s** is not a premium member!',
  profile_desc = "`👤` | **User:** `%s`\n`💰` | **Plan:** `%s`\n`📅` | **Expires At:** %s",
