return {
  ...
  queue_footer = 'หน้าที่ • %s/%s | เพลงในคิว • %s | ระยะเวลาทั้งหมด • %s',
  -- Pause
  ...
  -- Stop
  stop_msg = '`⏹️` | หยุด **เพลง** เรียบร้อยแล้ว!',
  -- Volume
  volup_msg = '`🔊` | เพิ่มระดับเสียงเป็น **%s%**',
  voldown_msg = '`🔉` | ลดระดับเสียงเป็น **%s%**',
  ...
  loop_invalid = '`⚠️` | กำหนดวนลูปไม่ถูกต้อง กรุณาใช้โหมด %s!',
  loop_already = '`⚠️` | โหมดวนลูปถูกตั้งเป็น **%s** อยู่แล้ว!',
  -- Previous
  ...
  -- All filter command!
  filter_on = '`✅` | เปิดใช้งานฟิลเตอร์ %s แล้ว!',
  filter_already = '`⚠️` | ฟิลเตอร์ %s เปิดใช้งานอยู่แล้ว!',

  -- Reset command!
  reset_on = '`❌` | ฟิลเตอร์ถูก **ปิด** แล้ว!',
  reset_already = '`⚠️` | ฟิลเตอร์โดน **ปิด** อยู่แล้ว!',
}