return {
  ...
  -- Blacklist error
  bl_user = '`❌` | You have been blocked by <@%s>, please contact the owner to resolve',
  bl_guild = '`❌` | This server has been blocked by <@%s>, please contact the owner to resolve or use another server',
}